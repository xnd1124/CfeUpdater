...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = Объект.ПрограммаПросмотраИзменений; 
...
Процедура СбросНастроекПоУмолчаниюНаСервере() 
	...
	ПараметрыКоманднойСтроки2Файла = Объект["ПараметрыКоманднойСтроки2Файла" 
		+ Объект.ПрограммаПросмотраИзменений]; 
	ПараметрыКоманднойСтроки3Файла = Объект["ПараметрыКоманднойСтроки3Файла"
		+ Объект.ПрограммаПросмотраИзменений]; 
КонецПроцедуры    

&НаСервере
Процедура ЗаполнитьРеквизитыФормы()
	ПутьКПрограмме = Объект["ПутьДо" + Объект.ПрограммаПросмотраИзменений];  
	ПараметрыКоманднойСтроки2Файла = Объект["ПараметрыКоманднойСтроки2Файла"
		+ Объект.ПрограммаПросмотраИзменений]; 
	ПараметрыКоманднойСтроки3Файла = Объект["ПараметрыКоманднойСтроки3Файла" 
		+ Объект.ПрограммаПросмотраИзменений]; 
