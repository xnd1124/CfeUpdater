...
* Отслеживание изменений заимствованных схем компоновки данных. Если вендор изменяет СКД например в заимствованном отчёте, расширение продолжает работать со старой структурой макета переопределенной в расширении. Выявить такое расхождение можно только вручную
