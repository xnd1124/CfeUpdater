...
Также обработка пытается автоматически разрешить конфликты, возникшие в результате обновления и применить изменения в новой версии расширения
<br>
...
<br>
4. Так же при первом запуске автоматически откроется окно настроек, предлагающее выбрать какую программу использовать для просмотра изменений, указать ее место расположение
<img width="1029" height="143" alt="image" src="https://github.com/user-attachments/assets/64b3e539-1173-4b0f-add3-81194db34d74" />

Рекомендуется выбрать Kdiff3 https://download.kde.org/stable/kdiff3/ (более богатые возможности по просмотру изменений)
